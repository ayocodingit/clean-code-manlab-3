...
class AjaxTableExport implements FromCollection, WithEvents, WithMapping, WithHeadings, WithColumnFormatting, ShouldAutoSize , WithTitle 
{
    ...
    public function __construct($models, $header, $mapping, $column_format,$title,$cellRange,$totals)
    {
        $this->models = $models;
        $this->header = $header;
    ...
    public function registerEvents(): array
    {
       return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getStyle("A1:{$this->cellRange}{$this->totals}")->applyFromArray($styleArray);
            },
        ];
